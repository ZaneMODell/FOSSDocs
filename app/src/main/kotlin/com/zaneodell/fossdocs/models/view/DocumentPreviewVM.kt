...
val sampleDocs = listOf(
    DocumentPreviewVM("Sample Cat", previewImageRes = R.mipmap.cat),
    DocumentPreviewVM("Sample Dog", previewImageRes = R.mipmap.dog),
    DocumentPreviewVM("Sample Cat 2", previewImageRes = R.mipmap.cat),
    DocumentPreviewVM("Sample Dog 2", previewImageRes = R.mipmap.dog),
    DocumentPreviewVM("Sample Cat", previewImageRes = R.mipmap.cat),
    DocumentPreviewVM("Sample Dog", previewImageRes = R.mipmap.dog),
    DocumentPreviewVM("Sample Cat 2", previewImageRes = R.mipmap.cat),
    DocumentPreviewVM("Sample Dog 2", previewImageRes = R.mipmap.dog),
